package com.example.alphavarient.nonEndPoints.BruteForce;
...
public class BruteForce {
    ...
    public static void main(String[] args) {
        ...
        bruteForce(5);
        bruteForce.endTime = System.currentTimeMillis();
        System.out.println("\n ****************************************************************************************************\n" +
                "\t\t\t\t\tTime taken to break password : " + (bruteForce.endTime-bruteForce.startTime) + " ms." +
                "\n ****************************************************************************************************\n");
    }
